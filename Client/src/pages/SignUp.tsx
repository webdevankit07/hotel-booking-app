...
const SignUp = () => {
    ...
    return (
        <div className='h-full'>
            ...
            <div className='relative py-10 text-gray-100 border-2 top-10 md:top-24 rounded-xl border-slate-300 backdrop-blur-md'>
                <form
                ...
                >
                    ...
                    <div className='flex flex-col gap-5 md:flex-row'>
                        <div className='flex-1'>
                            ...
                            />
                            <p className='h-2 px-3 pt-1 pb-3 text-sm font-bold text-red-500 drop-shadow-md shadow-black'>
